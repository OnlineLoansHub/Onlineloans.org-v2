...
const activeRatingStar = '/images/icons/ratings/onlineloans-empty-star-rating-icon.svg';
const inactiveratingStar = '/images/icons/ratings/onlineloans-5-star-rating-icon.svg';
