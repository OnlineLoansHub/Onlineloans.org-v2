  ...
  return (
    <div className="mt-3">
      <button
        ...
        className="flex items-center gap-2 text-sm text-[#235675] hover:text-[#1a4259] font-medium transition-colors"
      >
      ...
      {isExpanded && (
        <div className="mt-4 p-5 bg-slate-50 rounded-xl space-y-4">
          <div>
