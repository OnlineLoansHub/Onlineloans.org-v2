// Centralized exports for all brand data
export type { Brand, Lender } from './brands';
export { businessLoansData } from './businessLoansData';
export { personalLoansData } from './personalLoansData';
