            ...
            <ul className={cls.aboutList}>
              <li className={classNames(cls.aboutListItem, {}, [cls.aboutListItem1])}>
                ...
                <p className={cls.aboutListItemTxt}>
                  ...
                  knowledge and insights needed to make informed and confident financial decisions.
                  We
              ...
              <li className={classNames(cls.aboutListItem, {}, [cls.aboutListItem3])}>
                ...
                <p className={cls.aboutListItemTxt}>
                  ...
                  and analysis on every product or service. We examine specifications, user
                  feedback,
              ...
              <li className={classNames(cls.aboutListItem, {}, [cls.aboutListItem4])}>
                ...
                <p className={cls.aboutListItemTxt}>
                  Consumer Empowerment: Our goal is to equip consumers with the essential
                  information they need to make informed and confident decisions. Quality: We are
                  committed to excellence in our research and writing, ensuring that we deliver the
                  highest quality content possible. Accessibility: We strive to make our content
                  straightforward and accessible to everyone, regardless of their level of
                  expertise.
                </p>
              </li>
              <li className={classNames(cls.aboutListItem, {}, [cls.aboutListItem5])}>
                ...
                <p className={cls.aboutListItemTxt}>
                  We love hearing from our users! If you have any questions, feedback, or
                  suggestions, feel free to reach out to us. Your input helps us improve and serve
                  you better. Email: Contact@onlineloans.org
                </p>
              </li>
            </ul>
          </div>
