...
const financialProductSchema = {
  ...
  name: 'Business Loans',
  description:
    'Compare the best business loans of 2026 from top lenders. Find fast funding options with competitive rates and flexible terms for your business needs.',
  provider: {
    '@type': 'Organization',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 3,
      name: 'Best Business Loans of 2026',
      item: 'https://www.onlineloans.org/business-loan/best-business-loans',
    },
  ],
};

export default function BestBusinessLoansClient() {
  useEffect(() => {
