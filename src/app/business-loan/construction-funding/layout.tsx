...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Construction Business Loans Guide - How Construction Loans Work | OnlineLoans.org',
  description:
    'Complete guide to construction business loans: Learn how construction loans work, types of construction financing, how to apply, and find the best lenders. Compare equipment financing, working capital loans, and project funding for construction companies. Get approved in 24-72 hours.',
  keywords:
